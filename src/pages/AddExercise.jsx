            ...
            <div className="bg-[#1F293766] border border-[#37415166] rounded-2xl p-[25px] backdrop-blur-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <textarea placeholder='Key form cues and technique tips...' rows="4" className='w-full mt-2 px-4 py-3 rounded-xl border border-[#4B556380] bg-[#37415180] text-white placeholder-[#9CA3AF] focus:outline-none focus:border-green-500 font-[400] text-[15px]' ></textarea>
                </div>
                <div>
                   <label className="text-[14px] text-[#D1D5DB] font-[400] mb-2">Safety Notes</label>
                  <textarea placeholder='Important safety considerations and warnings...' rows="4" className='w-full mt-2 px-4 py-3 rounded-xl border border-[#4B556380] bg-[#37415180] text-white placeholder-[#9CA3AF] focus:outline-none   focus:border-green-500 font-[400] text-[15px]' ></textarea>
                </div>
