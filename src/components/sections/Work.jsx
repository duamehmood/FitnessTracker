    ...
    return (
        <div className='bg-[#1e293b] lg:py-[100px] md:py-[70px] py-[50px] text-center'>
            <div className="container mx-auto">
                <h2 className='text-white font-bold lg:text-[35px] md:text-[30px] text-[25px] text-center '> How It <span className='bg-gradient-to-r from-[#4ADE80] to-[#60A5FA] bg-clip-text text-transparent '> Works</span> </h2>
